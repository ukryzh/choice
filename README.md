...
It is treated as a product experiment, not a startup. There is no monetization model. Nothing tracks you on the website, in the app, or anywhere in the pipeline.
...
To be decided before public release. Until then, all rights reserved.
